from CTL2.causal_tree.ctl.adaptive import *
from CTL2.causal_tree.ctl.honest import *
from CTL2.causal_tree.ctl.ctl_base import *
from CTL2.causal_tree.ctl.ctl_honest import *
from CTL2.causal_tree.ctl.ctl_val_honest import *

from CTL2.causal_tree.ctl_trigger.adaptive_trigger import *
from CTL2.causal_tree.ctl_trigger.ctl_base_trigger import *
from CTL2.causal_tree.ctl_trigger.ctl_honest_trigger import *
from CTL2.causal_tree.ctl_trigger.ctl_val_honest_trigger import *
from CTL2.causal_tree.ctl_trigger.honest_trigger import *
...
class CausalTree(_CausalTree):
    ...
    def __init__(self, cont=False, val_honest=False, honest=False, min_size=2, max_depth=-1, split_size=0.5, weight=0.5,
                 ...
                 max_values=None, verbose=False, nomin_test = 0.5):
        super().__init__()
        self.cont = cont
    ...
    def fit(self, x, y, t, nomin_test):
        ...
        y = y.astype(np.float)
        t = t.astype(np.float)
        self.tree.fit(x, y, t, nomin_test)
        self.fitted = True
